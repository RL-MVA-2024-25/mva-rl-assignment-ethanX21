...
class ProjectAgent:
    ...
    def train(self, env, max_episode):
        ...
        while episode < max_episode:
            ...
            if done or trunc:
                ...
                if episode_cum_reward > best_previous_val:
                    print("New best model found! Saving model...")
                    best_previous_val = episode_cum_reward
    ...
    def save(self, path):
        pos = os.path.join(os.sep, path, 'model.pth')
        torch.save(self.model.state_dict(), pos)
        print("Model saved at ", pos)
...
if __name__ == "__main__":
    agent = ProjectAgent()
    agent.train(env=env, max_episode=250)